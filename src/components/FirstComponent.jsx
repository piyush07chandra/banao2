...
const signIn=()=>{
  ...
  return (
    <>
        <div className="first-comp pt-14 ">
            <div>
            ...
            <img className='fcimg'  src='/Group 27.png'/>
            </div>
        ...
        <div className='form mt-24 ml-16'>
            ...
            <div>
              ...
              <div className='mt-12 mb-3'>
                <button><img src='/Login With Other Accounts.png'/></button>
                <button><img src='/Login With Other Accounts (1).png'/></button>
                </div>
...
<span className='flex'>
        ...
        >
          {showPassword ? (
            <img className='bg-white' src='/Vector.png'/>
            
          ) : (
            <img className='bg-white' src='/Vector (3).png'/>
          )}
        </button>
        </span>
...
<span className='flex'>
      ...
      <a href='#' className='flex forgot'><img className='h- w-5' src='/Vector (2).png'/>Forgot Password</a>
      </span>
